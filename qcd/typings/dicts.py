...
class ResultsToPlot(TypedDict):
    ...
    eta0_success_probabilities: List[float]
    eta1_success_probabilities: List[float]
    eta2_success_probabilities: List[float]
    ...
    counts_00_eta0: List[int]
    counts_00_eta1: List[int]
    counts_00_eta2: List[int]
    counts_01_eta0: List[int]
    counts_01_eta1: List[int]
    counts_01_eta2: List[int]
    counts_10_eta0: List[int]
    counts_10_eta1: List[int]
    counts_10_eta2: List[int]
    counts_11_eta0: List[int]
    counts_11_eta1: List[int]
    counts_11_eta2: List[int]
