...
from . import OneShotEntangledFullInputDampingChannel
...
class OneShotEntangledUniversalDampingChannel(OneShotEntangledFullInputDampingChannel):
    ...
    def build_from_optimal_configurations(file_name: str, path: Optional[str] = ""):
        ...
        return OneShotEntangledUniversalDampingChannel(optimal_configurations=load_result_from_file(file_name, path))
    ...
    def discriminate_channel(configuration: ChannelConfiguration, plays: Optional[int] = 100) -> float:
        ...
        """
        return OneShotEntangledUniversalCircuit().compute_average_success_probability(configuration, plays)
    ...
    def __init__(self,
        ...
        if optimal_configurations is not None:
            self._one_shot_circuit = OneShotEntangledUniversalCircuit(optimal_configurations)
